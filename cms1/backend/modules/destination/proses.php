...
//  el usuario ya ha iniciado sesión, a continuación, ejecutar el comando para insertar, actualizar y borrar
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['save'])) {
            ...
            $path               = "../../../images/destinos/".$nama_file;
            ...
            if(in_array($extension, $allowed_extensions)) {
                ...
                if($ukuran_file <= 1000000) { // Comprueba si el tamaño del archivo subido menos igual a 1 MB
                    ...
                    if(move_uploaded_file($tmp_file, $path)) { // Compruebe si la imagen fue subida o no con éxito
                        ...
                        $query = mysqli_query($mysqli, "INSERT INTO destination(title,image)
    ...
    elseif ($_GET['act']=='update') {
        if (isset($_POST['save'])) {
            if (isset($_POST['destination_id'])) {
                ...
                $destination_id       = mysqli_real_escape_string($mysqli, trim($_POST['destination_id']));
                $title              = mysqli_real_escape_string($mysqli, trim($_POST['title']));
                ...
                if (empty($nama_file)) {
                    ...
                    $query = mysqli_query($mysqli, "UPDATE destination SET title        = '$title'
                    ...
                    if ($query) {
                        ...
                        header("location: ../../main.php?module=destination&alert=2");
                    } 
                }
    ...
    elseif ($_GET['act']=='delete') {
        if (isset($_GET['id'])) {
            ...
            $query = mysqli_query($mysqli, "DELETE FROM destination WHERE destination_id='$destination_id'")
            ...
            if ($query) {
                ...
                header("location: ../../main.php?module=destination&alert=3");
            }
        }
    }       
}       
